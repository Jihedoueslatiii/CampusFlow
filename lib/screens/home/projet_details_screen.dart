...
class _ProjetDetailsScreenState extends State<ProjetDetailsScreen> {
  ...
  // Widget pour la légende du Gantt
            ...
            Row(
              children: [
                Container(
                  ...
                  child: Icon(Icons.qr_code, color: primaryColor, size: 20),
                ),
                const SizedBox(width: 12),
                Expanded(
                  child: Text(
