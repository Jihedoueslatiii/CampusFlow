  ...
  Future<void> _deleteProjet(int id) async {
    ...
    if (result == true) {
      ...
      if (rowsAffected > 0) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text('Échec de la suppression du projet.'),
            backgroundColor: primaryColor,
          ),
        );
      }
      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Icon(Icons.date_range, size: 16, color: primaryTextColor.withOpacity(0.6)),
        ...
        trailing: _isAdmin
          ...
          itemBuilder: (context) => [
            ...
            : Icon(Icons.chevron_right, color: primaryColor), // Flèche pour les non-admins
